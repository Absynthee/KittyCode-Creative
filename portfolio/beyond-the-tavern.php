            ...
            <div class="hero align-items-normal fade-content" id="hero">
                  <div class="hero-text fade-content">
                        ...
                        <div class="hero-description gap fade-content">
                              ...
                              <p>Rose at Beyond the Tavern wanted a website to showcase the artwork she creates for her
                                    Etsy shop
                                    of the same name. The website was designed to be one page layout plus a blog page so
                                    that all of
                                    the information was easily reachable in one place.</p>
                        </div>

                        <div class="hero-buttons">
                              <a href="https://absynthee.github.io/Beyond-The-Tavern/" target="_blank">
                  ...
                  <div class="hero-img full-width">
                        <img src="../images/portfolio/beyond-the-tavern/beyondthetavern.png"
            ...
            <section class="full-text fade-content">
                  <div class="section-text fade-content">
                        ...
                        <div class="section-description">
                              <p>For this project we used a combination of html, css, javascript and jquery. The website
                                    is
                                    enhanced with some smooth animations upon loading the main page, and the hero
                                    section contains a
                                    nice rotating vertical animated carousel which shows customers immediately what to
                                    expect from
                                    the site. The logo was created by the client and it was requested to keep the
                                    font-selection for
