...
<body style="display: block;">
      ...
      <div class="top-banner visually-hidden">
            <div class="top-banner-content">
                  <a href="https://www.instagram.com/p/DBCGTN3sqww/" target="_blank"><span>Website Giveaway is over!
                              Check out the results on Instagram.</span></a>
            </div>
      </div>
      ...
      <main>
            ...
            <div class="hero fade-content">
                  <div class="hero-text fade-content" id="hero">
                        ...
                        <div class="hero-description fade-content">
                              <p>KittyCode Creative is a modern <sparkly-text style="--sparkly-text-color: yellow">
                                          <strong>web design</strong>
                                    </sparkly-text>
                                    agency based in Eastbourne, East Sussex. We specialise in creating beautiful and
                                    professional bespoke web design,
                                    front-end web development and design solutions. Check out our portfolio below, or
                                    contact us for more information.</p>
                        </div>

                        <div class="hero-buttons">
                              <a href="services/web-design">
                                    <button class="" data-effect="throb">
                                          <span class="text">web design</span>
                                          <span class="shimmer"></span>
                                    </button>
                              </a>
                              <a href="contact">
                                    <button class="secondary" data-effect="none">
            ...
            <section class="blurbs fade-content">
                  <div class="blurb">
                        <div class="blurb-container">
                              ...
                              <h3>
                                    <sparkly-text style="--sparkly-text-color: orange" role="presentation">Fully
                                          Responsive</sparkly-text>
                              </h3>
                              <p>Your website will fit all mobile screens sizes, tablets, and desktop sizes so new
                                    clients can
                  ...
                  <div class="blurb">
                        <div class="blurb-container">
                              ...
                              <h3>
                                    <sparkly-text style="--sparkly-text-color: orange" role="presentation">Unique
                                          Design</sparkly-text>
                              </h3>
                  ...
                  <div class="blurb">
                        <div class="blurb-container">
                              ...
                              <h3>
                                    <sparkly-text style="--sparkly-text-color: orange" role="presentation">Accessibile
                                    </sparkly-text>
                              </h3>
                              <p>Making the web accessible benefits individuals, businesses, and society. Your website
                                    will be
            ...
            <div class="blur3"></div> -->
                  <div class="section-text fade-content">
                        ...
                        <div class="section-description">
                              <p>We offer a unique and personal service to each and every client. All of our websites
                                    are built
                                    from scratch and are available in monthly packages to keep your costs down.</p>

                              <p>Our web design solutions include an SEO service which helps your website rank well in
                                    search
                                    engines. If your aim is to raise visibility and gain traction on your website, we
                                    can help.</p>

                              <p>As well as web design and development, we provide a logo design service that is sure to
                                    improve
                                    your brand image.</p>
                        </div>
                  </div>
            ...
            <section class="why-choose-us fade-content" id="why-choose-us">
                  <div class="section-text fade-content">
                        <label for="why-choose-us">We’re the cat’s paw-jamas.</label>
                        <a href="about-us">
                              <h2 class="section-title">Why Choose Us</h2>
                        </a>
                        <div class="section-description">
                              <p>The cats behind KittyCode Creative strive to offer excellent, friendly personal
                                    service. No job
                                    is too big or too small. Feel free to contact us with any request, and we will try
                                    our best to
                                    achieve your vision.</p>
                              <p>Our goal is to provide unique and accessible websites for everyone. With our low
                                    pricing entry,
                                    we cater towards individuals promoting their personal website or portfolio, and
                                    small businesses
                                    hoping to improve their digital footprint.</p>
                        </div>
                  ...
                  <div class="section-img">
                        <div class="phone-container">
                              <div class="phone">
                                    <div class="phone-top-cutout"></div>
                                    <div class="phone-menu">
                                          <div class="menu-back">
                                                &lt; </div>
                                          <img src="images/kittycode_logo.svg" class="menu-avatar" alt="KittyCode Logo">
                                    ...
                                    <div class="chat-container">
                                          <div class="right-text">
                                                <div class="chat-user-2 phone-element">Hey KittyCode, we need a new
                                                      website!</div>
                                                <div class="chat-user-2 phone-element">Are you available to take us on?
                                                </div>
                                          </div>
                                          <div class="chat-user-1-special phone-element">
                                                <dotlottie-player
                                                      src="https://lottie.host/f9407abf-7229-4395-b661-ad87f888963d/AlRkb3hTeS.json"
                                                      background="transparent" speed="1"
                                                      style="width: 124px; height: 124px;" loop alt="KittyCode Sticker"
                                                      autoplay role="presentation"></dotlottie-player>
                                          </div>
                                          <div class="chat-user-1 phone-element">Hi there!</div>
                                          <div class="chat-user-1 phone-element">Sure thing! We can have an initial
                                                design for you in
                                                just a couple of days.</div>
                                          <div class="chat-user-1 phone-element">Just complete our website questionnaire
                                                and we'll
                                          ...
                                          <div class="right-text">
                                                <div class="chat-user-2 phone-element">Awesome. Thank you, KittyCode! 😍
                                                </div>
                                          </div>
                                    </div>
            ...
            <section class="our-services fade-content" id="our-services">
                  <div class="section-text centered fade-content">
                        <label for="our-services">We offer purrfection.</label>
                        <a href="services/web-design">
                              <h2 class="section-title">Our Services</h2>
                        </a>
                        <div class="section-description centered">
                              <p>We offer a variety of services with limited options to make the selection process
                                    easier for you.
                                    Our packages come in either monthly contracts which includes hosting, or a straight
                                    up
                                    purchase of the design which you are able to take away and choose your own hosting.
                              </p>
                              ...
                              <div class="services-toggle">
                                    <input id="toggle-on" onclick="translatePaymentTypeMonthly()"
                                          class="toggle toggle-left" name="toggle" value="false" type="radio" checked>
                                    <label for="toggle-on" class="toggle-button" tabindex="0"
                                          role="option">Monthly</label>
                                    <input id="toggle-off" onclick="translatePaymentTypeOneOff()"
                                          class="toggle toggle-right" name="toggle" value="true" type="radio">
                                    <label for="toggle-off" class="toggle-button" tabindex="0"
                                          role="option">One-off</label>
                              </div>
                        </div>
                        ...
                        <div class="packages fade-content">
                                    ...
                                    <section class="card">
                                          <div class="inside">
                                                ...
                                                <div class="card-extras">
                                                      <p class="monthly-contract">12 month contract</p>
                                                      <p class="one-off-deposit">50% deposit required</p>
                                                      <p id="design-fee-standard"><label
                                                                  for="design-fee-standard">£300</label> initial
                              ...
                              <section class="card primary">
                                    <div class="inside">
                                          <div class="popular">
                                                <sparkly-text style="--sparkly-text-color: yellow" role="presentation">
                                                      recommended
                                                </sparkly-text>
                                          </div>
                                          <div class="card-plan">
                                          ...
                                          <div class="card-extras">
                                                <p class="monthly-contract">24 month contract</p>
                                                <p class="one-off-deposit">50% deposit required</p>
                                                <p id="design-fee-premium"><label for="design-fee-premium">£450</label>
                                                      initial design
                                                      fee applies</p>
                                          </div>
                                          <div class="centered-button">
                                    ...
                                    <section class="card">
                                          <div class="inside">
                                                ...
                                                <div class="card-extras">
                                                      <p class="monthly-contract">24 month contract</p>
                                                      <p class="one-off-deposit">50% deposit required</p>
                                                      <p id="design-fee-premium-plus"><label
                                                                  for="design-fee-premium-plus">£750</label>
            ...
            <div class="blur4"></div> -->
                  <div class="section-text centered fade-content">
                        ...
                        <div class="section-description centered">
                              <p>These are the projects we have completed for clients.</p>
                        </div>
                  </div>
                ...
                There's also a page dedicated to fan art, which is pulled directly from Bluesky.</p> -->
                  ...
                  <div class="section-buttons centered-button">
                        <a href="our-portfolio"><button class="" data-effect="throb">
                                    <span class="text">see portfolio</span>
                                    <span class="shimmer"></span>
                              </button></a>
                  </div>
            </section>

            <section class="our-reviews fade-content" id="our-reviews">
                  <div class="section-text centered fade-content">
                        <label for="our-reviews">We think you’re pretty paw-some.</label>
                        <h2 class="section-title">Our Reviews</h2>
                        <div class="section-description centered">
                              <p>Testimonials from the cool cats who have hired us.</p>
                        </div>
                  </div>
                  ...
                  <div class="testimonial-container">
                        ...
                        <div class="quoteLoop">
                              <blockquote class="quote"> <img src="images/reviews/beyond-the-tavern.jpg"
                                    ...
                                    <p>Austin really impressed me with their attention to detail when designing my new
                                          business
                                          website. Every part was so well thought out, and I appreciated them going the
                                          extra mile to
                                          add in the interactive and animated elements I asked for. To any startup small
                                          business,
                                          entrepreneur, or influencer looking for a responsive, fast and aesthetically
                                          pleasing
                                          website, I'd definitely recommend KittyCode Creative! 😺</p>
                                    <span class="span-title">Rose Butcher, Beyond the Tavern</span>
                              </blockquote>

                              <blockquote class="quote"> <img src="images/reviews/ctrlaltcookie.jpg"
                                          alt="Testimonial Author" />
                                    <p>Working with KittyCode Creative on my website was easy and fluid, they responded
                                          to my requests the same day and pitched in a lot of ideas that ended up being
                                          better than what I'd come up with anyway. The website they've made me is now
                                          my landing pad for everyone on the internet to get to know me as a brand so
                                          I'm beyond thrilled with how it's all turned out.</p>
            ...
            <div class="blur5"></div> -->
                  <div class="section-text fade-content">
                        ...
                        <div class="section-description">
                              <p>If you can’t find an answer to one of your burning questions, please get in touch.
                                    Hopefully
                                    though, we already have the answers right here!</p>
                        </div>

                        <div class="faq open" tabindex="0" role="article">
                              <span class="span-title">Why should we choose you?</span>
                              <p>We're certainly glad you're considering us! As a new agency we don't have the portfolio
                                    of
                                    others that have been around for years. However, we have all the skills and know-how
                                    to
                                    deliver you the best website for your needs... and we do it cheaper than anyone
                                    else.</p>
                        </div>
                        <div class="faq closed" tabindex="0" role="article">
                              <span class="span-title">I already have a website, I just need you to manage it for me. Is
                                    this
                                    something you offer?</span>
                              <p>Absolutely! We have no set pricing for this sort of request, so it will depend on a
                                    case-by-case basis. Send us a message and we will gladly manage your website for
                                    you.</p>
                        </div>
                        <div class="faq closed" tabindex="0" role="article">
                              <span class="span-title">Is hosting included in your packages?</span>
                              <p>Yes, all of our monthly packages include hosting charges. This enables us to keep your
                                    website up and running. If you stop your monthly payments before your contract
                                    expires, your
                                    hosting will also stop. If you're not on a monthly package, we can host for you for
                                    an
                                    additional fee.</p>
                        </div>
                        <div class="faq closed" tabindex="0" role="article">
                              <span class="span-title">Do you offer SEO?</span>
                              <p>All of our web packages include SEO. While we cannot guarantee that your website will
                                    be
                                    listed within the top search results of Google, we will do our best to get your
                                    website as
                                    close to
                  ...
                  <div class="section-img">
                        <img src="images/faq.png" alt="The FAQs of our Web Design Agency">
                  </div>
            </section>
            ...
            <div class="blur6"></div> -->
                        ...
                        <div class="contact-container">
                              <form id="contact" action="" method="post" novalidate>
                                    ...
                                    <fieldset>
                                          ...
                                          <input placeholder="meow@kittycodecreative.com" name="email" id="email"
                                    ...
                                    <fieldset>
                                          ...
                                          <input placeholder="What do you knead?" name="subject" id="subject"
                                                type="text" required>
                                    ...
                                    <fieldset>
                                          ...
                                          <textarea
                                                placeholder="Leave a message. The button will be active after you type 5 words!"
                                    ...
                                    <fieldset aria-labelledby="contact-submit">
                                          <button disabled class="disabled" name="submit" type="submit"
                                                id="contact-submit" data-effect="spin">
                  ...
                  <div class="section-img">
                        <img src="images/contact-us.png"
                              alt="Contact KittyCode Creative, an Eastbourne based Web Design Agency">
                  </div>
            </section>
