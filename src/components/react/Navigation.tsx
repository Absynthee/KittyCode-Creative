...
.mobile-toggle input + div:after {
  ...
  top: 50%;
  left: 50%;
  box-shadow: 1px -22px 0 var(--toggle-color), 1px 23px 0 var(--toggle-color),
    23px 0 0 var(--toggle-color), -21px 0 0 var(--toggle-color),
    17px 15px 0 var(--toggle-color), -15px 15px 0 var(--toggle-color),
    17px -15px 0 var(--toggle-color), -15px -15px 0 var(--toggle-color);
  transform: scale(0);
  transition: all 0.3s ease;
}
